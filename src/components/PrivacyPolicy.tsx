...
const PrivacyWeb = () => {
  return (
    <div className="min-h-screen bg-[#F5FBFF] dark:bg-[#030712] text-gray-900 dark:text-zinc-100 selection:bg-cyan-500 selection:text-white p-6 md:p-12 pb-24">
      <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="md:col-span-8 bg-white dark:bg-zinc-900 rounded-[2.5rem] p-10 md:p-16 border border-gray-100 dark:border-white/5 relative overflow-hidden flex flex-col justify-center">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-gray-500 dark:text-zinc-400 font-medium max-w-lg leading-relaxed">
                DocVault isn't just "private" by policy; it's private by architecture. We've eliminated the server entirely, ensuring that "No Data Found" is a technical reality, not just a promise.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-8 bg-white dark:bg-zinc-900 rounded-[2.25rem] border border-gray-100 dark:border-white/5 shadow-sm space-y-4">
            <div className="w-10 h-10 bg-cyan-50 dark:bg-cyan-950/20 text-cyan-500 rounded-xl flex items-center justify-center">
              <Cpu size={20} />
            </div>
        ...
        <div className="p-10 bg-emerald-500 text-white rounded-[3rem] flex flex-col md:flex-row items-center gap-10 relative overflow-hidden shadow-2xl shadow-emerald-500/20">
           ...
           <div className="flex-1 text-center md:text-left relative z-10">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                 <a href="https://github.com/Gnanendra494/DocVault" target="_blank" className="px-8 py-3 bg-white text-emerald-600 rounded-xl font-black uppercase text-[10px] tracking-widest hover:scale-105 transition-transform flex items-center gap-2 shadow-lg">
        ...
        <div className="pt-12 text-center opacity-30">
           <DocVaultLogo size={32} iconColor="#10B981" partColor="currentColor" className="mx-auto mb-4" />
      ...
      <div className="px-4 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-4">
        ...
        <div className="bg-zinc-900 text-white rounded-[2rem] p-8 relative overflow-hidden">
           ...
           <p className="text-xs text-zinc-400 leading-relaxed font-medium mb-6">
              DocVault is a transparent document workspace. We believe your data belongs to you, and we build tools that make that technically enforceable.
           </p>
           <a 
             href="https://github.com/Gnanendra494/DocVault" 
             target="_blank" 
