/**
 * DocVault - About & Protocol Specification
    ...
    <div className="border-b border-gray-100 dark:border-zinc-800 last:border-0 overflow-hidden">
      ...
      >
        <div className="flex items-center gap-5">
          <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-500 ${isOpen ? 'bg-cyan-500 text-white shadow-lg shadow-cyan-500/20' : 'bg-gray-50 dark:bg-zinc-900 text-gray-400 group-hover:text-cyan-500 group-hover:bg-cyan-50 dark:group-hover:bg-cyan-950/10'}`}>
        ...
        <div className={`p-2 rounded-full transition-all ${isOpen ? 'bg-cyan-50 dark:bg-cyan-950/20 text-cyan-500' : 'text-gray-300'}`}>
...
const AboutWeb = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5FBFF] dark:bg-[#030712] text-gray-900 dark:text-zinc-100 selection:bg-cyan-500 selection:text-white pb-24">
      
      {/* 1. Impact Hero - Compact */}
      <section className="relative pt-20 pb-12 px-6 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-[radial-gradient(circle_at_center,rgba(0,242,254,0.08),transparent_60%)] pointer-events-none" />
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter dark:text-white mb-6 leading-[0.9] animate-in fade-in slide-in-from-bottom-4 duration-700">
            Privacy is a <br/>
            <span className="text-cyan-500 font-black">Human Right.</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-500 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
            DocVault is an absolute document engine. No servers, no tracking, no compromises. We transform your browser into a self-contained document laboratory.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 mb-20">
        <div className="bg-cyan-500 text-white rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 relative overflow-hidden shadow-xl shadow-cyan-500/20">
           ...
           <div className="flex-1 text-center md:text-left relative z-10">
              ...
              <p className="text-cyan-100 font-medium text-base mb-6 max-w-xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <h2 className="text-3xl font-black tracking-tighter dark:text-white leading-[1.1]">
              Architecture of <br/>
              <span className="text-cyan-500">Absolute Sovereignty.</span>
            </h2>
            <p className="text-gray-500 dark:text-zinc-400 text-sm font-medium leading-relaxed">
              DocVault rejects the trade-off between convenience and privacy. We've built an engine that runs where the user is, ensuring your sensitive data never crosses a network boundary.
            </p>
            <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-sm">
               ...
               <p className="text-xs text-gray-500 dark:text-zinc-400 font-medium leading-relaxed">
                  We operate no backend. No databases. No file caches. DocVault is a static distribution of code that activates your browser's existing power.
               </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 bg-white dark:bg-zinc-900 rounded-[2.5rem] p-2 md:p-6 border border-gray-100 dark:border-white/5 shadow-sm">
             <SpecItem title="How it Works" icon={CpuIcon} defaultOpen={true}>
                Every action is executed locally on your device's CPU. Using high-performance <span className="text-cyan-500 font-bold">Web Workers</span> and <span className="text-cyan-500 font-bold">WebAssembly</span>, DocVault loads your PDF into a sandboxed environment within your browser tab.
             </SpecItem>

             <SpecItem title="Data Lifecycle" icon={PrivacyIcon}>
                Your documents live exclusively in your browser's <span className="text-cyan-500 font-bold">volatile memory (RAM)</span>. We do not use persistent storage or cookies for your file content. Once the tab is closed, the data is destroyed.
             </SpecItem>
             ...
             <SpecItem title="Radical Transparency" icon={CodeIcon}>
                DocVault is <span className="text-cyan-500 font-bold">100% Open Source</span> under the <span className="text-cyan-500 font-bold">GNU AGPL v3</span> license. This gives you the right to audit every line of code and guarantees the engine remains free.
             </SpecItem>
    ...
    <NativeToolLayout title="Protocol" description="System Internals" actions={null}>
      <div className="px-4 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-4">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[2rem] p-6 border border-gray-100 dark:border-white/5 shadow-sm flex flex-col items-center text-center">
          <div className="w-20 h-20 bg-gray-50 dark:bg-[#030712] rounded-[1.5rem] flex items-center justify-center shadow-inner mb-4">
            <DocVaultLogo size={40} iconColor="#00F2FE" partColor="currentColor" />
          </div>
          <h2 className="text-2xl font-black tracking-tighter dark:text-white leading-none mb-1">DocVault</h2>
          <p className="text-[9px] font-black uppercase tracking-widest text-cyan-500">v1.0.9 Stable • Absolute Privacy</p>
        </div>

        {/* 2. Fuel the Engine (Prominent Support - MOVED TO TOP) */}
        <div className="bg-cyan-500 text-white rounded-[2rem] p-6 relative overflow-hidden shadow-xl shadow-cyan-500/20">
           ...
           <div className="relative z-10">
              ...
              <p className="text-sm font-medium text-cyan-100 leading-relaxed mb-6">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[2rem] p-2 border border-gray-100 dark:border-white/5 shadow-sm overflow-hidden">
           ...
           <div className="divide-y divide-gray-50 dark:divide-white/5 px-2">
              <SpecItem title="How it Works" icon={CpuIcon}>
                Every action you perform—merging, splitting, or encrypting—happens locally on your device's CPU. DocVault uses an internal local engine powered by <span className="text-cyan-500 font-bold">pdf-lib</span> and <span className="text-cyan-500 font-bold">WebAssembly</span>. No data ever leaves your hardware.
              </SpecItem>

              <SpecItem title="Data Privacy" icon={PrivacyIcon}>
                Your files are loaded into the app's <span className="text-cyan-500 font-bold">volatile memory (RAM)</span> only during your active session. We do not use persistent storage for your PDF content. Once you close the app or navigate away, the processed document is permanently purged.
              </SpecItem>

              <SpecItem title="Deep Metadata Clean" icon={DiskIcon}>
                Privacy isn't just about servers. Most tools leave digital breadcrumbs in the PDF metadata. DocVault's "Deep Clean" protocol sanitizes every document, purging Producer, Creator, and XMP metadata to ensure absolute anonymity.
              </SpecItem>

              <SpecItem title="Open Source Integrity" icon={CodeIcon}>
                Trust is earned through transparency. DocVault is <span className="text-cyan-500 font-bold">100% open-source</span> under the <span className="text-cyan-500 font-bold">GNU AGPL v3</span> license. This ensures the engine remains free, auditable, and community-driven forever.
              </SpecItem>

              <SpecItem title="Zero Infrastructure" icon={ServerOffIcon}>
                We operate a <span className="text-cyan-500 font-bold">Zero-Server Architecture</span>. We have no backend, no database, and no cloud. Your phone is the laboratory, and your documents stay in your hands alone.
              </SpecItem>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-2 pt-2">
          ...
          <button onClick={() => navigate('/thanks')} className="flex items-center justify-between p-5 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 rounded-[2rem] active:scale-[0.98] transition-all">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-cyan-50 dark:bg-cyan-950/20 rounded-xl flex items-center justify-center">
