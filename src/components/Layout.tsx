        ...
        <header className="flex items-center justify-between px-4 md:px-8 h-16 md:h-20 border-b border-gray-100 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md sticky top-0 z-[100]">
          <div className="flex items-center gap-2 md:gap-4 flex-1 min-w-0">
            ...
            <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity shrink-0">
              <DocVaultLogo size={Capacitor.isNativePlatform() ? 24 : 28} iconColor="#F43F5E" />
            ...
            <div className="grid grid-cols-2 md:grid-cols-12 gap-8 mb-12">
              ...
              <div className="col-span-2 md:col-span-6 space-y-4">
                <Link to="/" className="flex items-center gap-2.5 text-gray-900 dark:text-white group w-fit">
                  <DocVaultLogo size={22} iconColor="#F43F5E" partColor="currentColor" />
                  <span className="font-bold tracking-tight text-lg group-hover:text-rose-500 transition-colors">DocVault</span>
                </Link>
                ...
                <div className="flex items-center gap-2 pt-1">
                   ...
                   <a href="https://github.com/yourusername/DocVault" target="_blank" className="p-2 bg-gray-50 dark:bg-zinc-900 rounded-xl hover:bg-rose-500 hover:text-white transition-all text-gray-500 dark:text-zinc-500">
                     <GHIcon size={14} />
                   </a>
                </div>
              </div>
              ...
              <div className="col-span-1 md:col-span-3">
                ...
                <ul className="space-y-2.5 text-xs text-gray-500 dark:text-zinc-500">
                  ...
                  <li><a href="https://github.com/yourusername/DocVault/blob/main/LICENSE" target="_blank" className="hover:text-rose-500 transition-colors">License</a></li>
                </ul>
              </div>
              ...
              <div className="col-span-1 md:col-span-3">
                ...
                <ul className="space-y-2.5 text-xs text-gray-500 dark:text-zinc-500">
                  <li><a href="https://github.com/sponsors/yourusername" target="_blank" className="flex items-center gap-2 hover:text-rose-500 transition-colors">Sponsor <HeartIcon size={10} className="text-rose-500" /></a></li>
                  <li><a href="https://github.com/yourusername/DocVault/issues" target="_blank" className="hover:text-rose-500 transition-colors">Report Bug</a></li>
