      ...
      <header className="fixed top-0 inset-x-0 px-4 pt-[calc(env(safe-area-inset-top)+0.75rem)] pb-4 bg-zinc-900/95 backdrop-blur-xl border-b border-white/5 flex items-center justify-between z-50 shadow-lg" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5 min-w-0">
             <div className="w-9 h-9 bg-white rounded-xl flex items-center justify-center shadow-xl shrink-0">
                <DocVaultLogo size={20} iconColor="#00F2FE" partColor="#000000" />
             </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            className="w-10 h-10 flex items-center justify-center bg-cyan-500 text-white rounded-2xl shadow-lg shadow-cyan-500/20 active:scale-95 active:bg-cyan-500 transition-all border border-cyan-300/20"
          >
        ...
        <div className="min-h-full flex flex-col items-center pt-32 pb-40 space-y-12">
          ...
          {isLocked ? (
            <div className="h-full flex flex-col items-center justify-center text-center px-8">
              <div className="w-20 h-20 bg-cyan-500/10 text-cyan-500 rounded-[2.5rem] flex items-center justify-center mb-8 shadow-inner border border-cyan-500/20">
                <Lock size={32} />
              </div>
              ...
              <div className="w-full max-w-xs space-y-3 mb-10">
                 <input 
                   ...
                   className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white font-bold text-center outline-none focus:border-cyan-500 transition-all"
                   autoFocus
                 />
                 <button 
                   onClick={handleUnlock}
                   disabled={!password || isUnlocking}
                   className="w-full py-4 bg-cyan-500 text-white rounded-2xl font-black uppercase text-xs tracking-widest shadow-xl active:scale-95 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                 >
