    ...
    <div className="animate-in slide-in-from-bottom duration-500 fade-in space-y-6">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex gap-3">
          ...
          <button 
            onClick={handleShare}
            className="flex-1 bg-cyan-50 dark:bg-cyan-950/20 text-cyan-500 border border-cyan-100 dark:border-cyan-950/30 p-4 rounded-2xl md:rounded-3xl shadow-sm font-black text-sm md:text-xl tracking-tight transition-all active:scale-95 flex items-center justify-center gap-2"
          >
      ...
      <button 
        onClick={onStartOver}
        className="w-full mt-6 py-4 bg-gray-50 dark:bg-zinc-900 text-gray-400 hover:text-cyan-500 dark:hover:text-cyan-500 rounded-2xl border border-gray-100 dark:border-white/5 font-black text-[10px] uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 active:scale-95 shadow-sm"
      >
